...
export const PAYMENT_CHECK_ALL = Symbol.for('PAYMENT_CHECK_ALL')
export const PAYMENT_UPDATE_PAGINATION = Symbol.for('PAYMENT_UPDATE_PAGINATION')
export const SET_SELECTED_BATCH = Symbol.for('SET_SELECTED_BATCH')
